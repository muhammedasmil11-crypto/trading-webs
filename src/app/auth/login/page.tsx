...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#060913] px-4 md:px-6 relative overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center text-center space-y-4 mb-6">
          ...
          <div>
            <h2 className="font-bold text-white text-xl">Sign in to Trading Journal</h2>
            <p className="text-xs text-fg-muted mt-1 leading-normal">
              Secure local database journal. Keep your statistics private.
            </p>
          </div>
        </div>
        ...
        <div className="text-center mt-6 text-xs text-fg-muted">
          New to the journal?{' '}
          <Link href="/auth/signup" className="text-primary-main hover:underline font-bold">
            Create an Account
          </Link>
        </div>
      </motion.div>
